            ...
            <ul>
                ...
                <li>
                    <?php
                        ...
                        echo '<div class="input">' . form_input('title',$item->title) . '</div>';
                    ?>
                </li>
                <li>
                    <?php
                        echo form_label(lang('opensong:Author').' <span>*</span>', 'author');
                        echo '<div class="input">' . form_input('author',$item->author) . '</div>';
                    ?>
                </li>
                <li>
                    <?php
                        echo form_label(lang('opensong:Copyright').' <span>*</span>', 'copyright');
                        echo '<div class="input">' . form_input('copyright',$item->copyright) . '</div>';
                    ?>
                </li>
                <li>
                    <?php
                        echo form_label(lang('opensong:Lyrics').' <span>*</span>', 'lyrics');
                        echo '<div class="input">' . form_textarea('lyrics',$item->lyrics,'style="font-family:courier;"') . '</div>';
                    ?>
                </li>
